...
const selfCareToolCards: TopicCard[] = [
  { id: "daily-journal", icon: Clock, label: "Daily Journal", bgColor: "linear-gradient(135deg, #a855f7 0%, #9333ea 100%)", iconColor: "#A855F7", url: "https://web.mantracare.com/app/journal" },
  ...
  { id: "recovery-progress", icon: TrendingUp, label: "Recovery Progress", bgColor: "linear-gradient(135deg, #10b981 0%, #059669 100%)", iconColor: "#10B981", url: "https://web.mantracare.com/app/recovery_tracker" },
];
